...
export class OAuthService {
     ...
     */
    async exchangeFacebookCode(clientId: string, clientSecret: string, code: string): Promise<{
        accessToken: string;
        expiresIn?: number;
    }> {
        const redirectUri = this.configService.get<string>(
     ...
     */
    async exchangeGoogleCode(clientId: string, clientSecret: string, code: string): Promise<{
        accessToken: string;
        refreshToken?: string;
        expiresIn?: number;
    }> {
