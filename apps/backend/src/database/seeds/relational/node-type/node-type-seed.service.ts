  ...
  async run() {
    const nodeTypes = [
      ...
      },
      {
        ...
        color: '#9C27B0',
        bgColor: '#9C27B020',
        description: 'Define an input field for the flow (Dynamic Form)',
        isTrigger: false,
        sortOrder: 4,
        properties: [
          {
            ...
            type: 'string',
            required: true,
            description: 'Unique identifier for this input (e.g. user_name)',
          },
          {
            name: 'label',
            label: 'Display Label',
            type: 'string',
            required: true,
            description: 'Label shown to the user (e.g. Your Name)',
          },
          {
            name: 'type',
            label: 'Input Type',
      ...
      },
      {
        ...
        color: '#E91E63',
        bgColor: '#E91E6320',
        description: 'Search Knowledge Base with semantic retrieval',
        sortOrder: 22,
        isPremium: true,
        properties: [
          {
            ...
            type: 'text',
            required: true,
            placeholder: 'e.g. {{input.message}} or specific query...',
            helpText:
              'The text to search for in the Knowledge Base. Supports variables.',
          },
          {
          ...
          },
          {
            ...
            max: 1,
            step: 0.05,
            helpText: 'Closer to 1.0 means more exact match required.',
          },
        ],
      },
      {
